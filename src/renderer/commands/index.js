...
const commands = [
...

  {
    id: 'file.new-tab',
    execute: async () => {
      window.api.localEmit('mt::new-untitled-tab', null)
    },
  },
  {
    id: 'file.new-window',
    execute: async () => {
      window.api.ipc.send('mt::cmd-new-editor-window')
    },
  },
  {
    id: 'file.open-file',
  ...
  },
  {
    id: 'file.save',
    execute: async () => {
      window.api.localEmit('mt::editor-ask-file-save', null)
    },
  },
  {
    id: 'file.save-as',
    execute: async () => {
      window.api.localEmit('mt::editor-ask-file-save-as', null)
    },
  },
  {
    id: 'file.print',
  ...
  },
  {
    ...
    execute: async () => {
      window.api.ipc.send('mt::cmd-close-window')
    },
  },

  {
    ...
    execute: async () => {
      window.api.ipc.send('mt::cmd-toggle-autosave')
    },
  },
  {
    id: 'file.move-file',
    execute: async () => {
      window.api.localEmit('mt::editor-move-file', null)
    },
  },
  {
    id: 'file.rename-file',
  ...
  },
  {
    ...
    execute: async () => {
      window.api.ipc.send('mt::window-toggle-always-on-top')
    },
  },
  {
...

  {
    ...
    executeSubcommand: async (_, value) => {
      window.api.localEmit('mt::window-zoom', null, value)
    },
  },
...

  {
    ...
    executeSubcommand: async (_, theme) => {
      window.api.ipc.send('mt::set-user-preference', { theme })
    },
  },
...

  {
    ...
    executeSubcommand: async (_, value) => {
      window.api.ipc.send('mt::set-user-preference', { textDirection: value })
    },
  },
  ...
  },
  {
    id: 'file.quit',
    execute: async () => {
      window.api.ipc.send('mt::app-try-quit')
    },
  },
  {
    id: 'docs.user-guide',
...

  {
    ...
    execute: async () => {
      window.api.localEmit('mt::tabs-cycle-right', null)
    },
  },
  {
    id: 'tabs.cycle-backward',
    execute: async () => {
      window.api.localEmit('mt::tabs-cycle-left', null)
    },
  },
]
...
if (isUpdatable()) {
  commands.push({
    ...
    execute: async () => {
      window.api.ipc.send('mt::check-for-update')
    },
  })
}
...
if (isOsx) {
  commands.push({
    id: 'edit.screenshot',
    execute: async () => {
      window.api.ipc.send('mt::make-screenshot')
    },
  })
}
