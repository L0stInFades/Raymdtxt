...
function Slugger(this: { seen: Record<string, number>; downcodeUnicode: boolean }) {
  this.seen = {}
...
Slugger.prototype.slug = function (this: { seen: Record<string, number>; downcodeUnicode: boolean }, value: string) {
