...
// biome-ignore lint/suspicious/noExplicitAny: legacy constructor-function pattern with dynamic token parsing
function Parser(this: any, options: Record<string, unknown>) {
  this.tokens = []
  this.token = null
  this.footnotes = null
