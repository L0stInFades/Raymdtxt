...
InlineLexer.prototype.output = function (src: string) {
  // src = src
  // .replace(/\u00a0/g, ' ')
...
InlineLexer.prototype.escapes = function (text: string) {
...
InlineLexer.prototype.outputLink = function (cap: RegExpExecArray, link: { href: string; title: string | null }) {
...
InlineLexer.prototype.mangle = function (text: string) {
