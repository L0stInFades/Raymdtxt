...
import type { IContentState, LineCursor } from '../types'

const marktextApi = (ContentState: { prototype: IContentState }) => {
  /**
  ...
  ContentState.prototype._replaceCurrentWordInlineUnsafe = function (this: IContentState, word: string, replacement: string) {
    ...
    const cursor: LineCursor = {
      start: Object.assign({}, start, { block: this.getBlock(start.key)! }),
      end,
    }
