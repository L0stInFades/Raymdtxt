...
const deleteCtrl = (ContentState: { prototype: IContentState }) => {
  // Handle `delete` keydown event on document.
  ContentState.prototype.docDeleteHandler = function (this: IContentState, event: KeyboardEvent) {
  ...
  ContentState.prototype.deleteHandler = function (this: IContentState, event: KeyboardEvent) {
