...
const codeBlockCtrl = (ContentState: { prototype: IContentState }) => {
   ...
   */
  ContentState.prototype.updateCodeLanguage = function (this: IContentState, block: Block, lang: string) {
   ...
   */
  ContentState.prototype.codeBlockUpdate = function (this: IContentState, block: Block, code = '', lang?: string) {
    if (block.type === 'span') {
  ...
  ContentState.prototype.resizeLineNumber = () => {
