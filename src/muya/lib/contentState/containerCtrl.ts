...
const containerCtrl = (ContentState: { prototype: IContentState }) => {
  ContentState.prototype.createContainerBlock = function (functionType: string, value = '', style = undefined) {
  ...
  ContentState.prototype.createPreAndPreview = function (functionType: string, value = '') {
  ...
  ContentState.prototype.initContainerBlock = function (functionType: string, block: Block, style = undefined) {
    // p block
    block.type = 'figure'
  ...
  ContentState.prototype.updateMathBlock = function (block: Block) {
