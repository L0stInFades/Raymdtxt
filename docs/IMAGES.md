...
Vien can automatically copy your images into a specified directory or handle images from clipboard.
...
Note: The assets directory name must be a valid path name and Vien need write access to the directory.
...
Vien only saves images from clipboard into the specified local directory.
