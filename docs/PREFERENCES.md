...
| startUpAction          | String  | lastState     | The action after Vien startup, open the last edited content, open the specified folder or blank page, optional value: `lastState`, `folder`, `blank` |
| defaultDirectoryToOpen | String  | `""`          | The path that should be opened if `startUpAction=folder`.                                                                                                  |
| language               | String  | en            | The language Vien use.                                                                                                                                |
...
| imageDropAction                    | String  | folder             | The default behavior after paste or drag the image to Vien, upload it to the image cloud (if configured), move to the specified folder, insert the path          |
...
| preferHeadingStyle  | String  | `atx`   | The preferred heading style in Vien, optional value `atx` `setext`, [more info](https://spec.commonmark.org/0.29/#atx-headings) |
