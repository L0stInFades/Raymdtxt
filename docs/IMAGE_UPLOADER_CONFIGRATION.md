...
3. Configure it in Vien Preferences. Click `CmdOrCtrl + ,` to open the settings window.
...
5. Paste an image into Vien and open the repository you created to verify the upload.
